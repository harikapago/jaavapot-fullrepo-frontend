...
import img1 from '../assets/img/reservation.jpg'
    ...
    <div>
      ...
      <div className="container" data-aos="fade-up">
        ...
        <div className="row g-0">
          ...
          <div className="col-lg-4 reservation-img" style={{backgroundImage: `url(${img1})`}} data-aos="zoom-out" data-aos-delay="200"></div>
